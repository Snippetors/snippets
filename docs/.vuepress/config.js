...
import tabsPlugin from '../../packages/@snippetors/vuepress-plugin-tabs'
import codeCopyPlugin from '../../packages/@snippetors/vuepress-plugin-code-copy'
  ...
  theme: defaultTheme(
    {
      ...
      sidebar: {
        ...
        "/basic/": [
          {
            title: "基础算法",
            children: ["/basic/", "/basic/quicksort", "/basic/mergesort"],
          },
        ],
        "/data_structure/": [
          {
